"""SQLAlchemy models for the API - schema only, no Streamlit dependencies."""
...
class Payment(Base):
    """Model für ein Payment. Typen: Einkauf, Rücklage, Korrektur, Auszahlung, Einzahlung, Miete"""
